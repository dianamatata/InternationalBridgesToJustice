...
class Paths:
    ...
    PATH_JSONL_FILE_WITH_LEGAL_FILES = "data/processed/legal_countries_docs/other_legal_docs.jsonl"
    PATH_JSONL_FILE_LEGAL_OTHERS = "data/processed/legal_countries_docs/other_legal_docs_chunks.jsonl"
...
legal_files_info_list = [
    {
        ...
        "path": os.path.join(Paths.PATH_FOLDER_LEGAL_FILES_PDF, "Indian_penal_code.pdf"),
        "country": "India",
        "language": "en",
    ...
    },
    {
        ...
        "path": os.path.join(Paths.PATH_FOLDER_LEGAL_FILES_PDF, "Burundi_Penal-Code-Revised_2009_FRENCH-1.pdf"),
        "country": "Burundi",
        "language": "fr",
        "legal_type": "penal_code",
    ...
    },
    {
        ...
        "path": os.path.join(Paths.PATH_FOLDER_LEGAL_FILES_PDF, "Accord_Arusha_Burundi.pdf"),
        "country": "Burundi",
        "language": "fr",
    ...
    },
    {
        ...
        "path": os.path.join(Paths.PATH_FOLDER_LEGAL_FILES_PDF, "Burundi-Code-2018-procedure-penale.pdf"),
        "country": "Burundi",
        "language": "fr",
    ...
    },
    {
        ...
        "path": os.path.join(Paths.PATH_FOLDER_LEGAL_FILES_PDF, "Burundi_Charte-de-l-Unite-nationale-1991.pdf"),
        "country": "Burundi",
        "language": "fr",
        "legal_type": "",
    ...
    },
    {
        ...
        "path": os.path.join(Paths.PATH_FOLDER_LEGAL_FILES_PDF, "China_penal_code1.pdf"),
        "country": "China",
        "language": "en",
        "legal_type": "",
