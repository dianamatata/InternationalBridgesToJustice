...
import sys
sys.path.append('/Users/dianaavalos/PycharmProjects/InternationalBridgesToJustice/VeriScore-main/veriscore')
from veriscore.claim_extractor import ClaimExtractor
os.environ[
    'OPENAI_API_KEY_PERSONAL'] = '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'
...
with open(input_file, "r", encoding="utf-8") as jsonl_file:
    data = [json.loads(line) for line in jsonl_file]  # Convert each line to a dictionary
